...
- `templates/plan-template.md` → For `.momorph/specs/{frame_id}-{frame_name}/plan.md`
- `templates/research-template.md` → For `.momorph/specs/{frame_id}-{frame_name}/research.md` (optional)
...
- `.momorph/specs/{frame_id}-{frame_name}/spec.md` - Feature specification (what to build)
- `.momorph/specs/{frame_id}-{frame_name}/design-style.md` - Design specifications (how it looks - IMPORTANT)
- `.momorph/contexts/BACKEND_API_TESTCASES.md` - Backend API test cases

## Purpose

Create a comprehensive implementation plan in `.momorph/specs/{frame_id}-{frame_name}/plan.md`
...
- Read the feature spec from `.momorph/specs/{frame_id}-{frame_name}/spec.md`
- Understand user stories and acceptance criteria
- Note technical requirements

**1.2. Load design-style (IMPORTANT for UI planning):**
- Read `.momorph/specs/{frame_id}-{frame_name}/design-style.md`
...
- Write to `.momorph/specs/{frame_id}-{frame_name}/plan.md`
